   ...
   <div class="womansurveyForm">
   		<form action="womanSurveyFormResult.pre" method="POST">
   			<fieldset>
   				...
   				<jsp:useBean class="action.SurveyCompleteCheckAction" id="bodyInfoList" scope="request"/>
				<jsp:getProperty id="bodyInfoList" property="name" />
				
				
				
   					<tr><td class="labelwidth"><label for="name">이름</label></td>
   					
   					<td><input type="text" name="name" id="name" value="123123"></td></tr>
   					...
   					<td><input type="number" name="age" id="age" min="1" max="150" required value="고쳐지나?"/></td></tr>
